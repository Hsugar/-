(function($){
    ...
    $.fn.pagination = function(options){
        var defaults = {
            ...
            */
            template: {
                first:'<li class="first" data-index="first"><a href="javascript:;">First</a></li>',
                last: '<li class="last" data-index="last"><a href="javascript:;">Last</a></li>',
                prev: '<li class="prev" data-index="prev"><a href="javascript:;">Prev</a></li>',
                next: '<li class="next" data-index="next"><a href="javascript:;">Next</a></li>',
